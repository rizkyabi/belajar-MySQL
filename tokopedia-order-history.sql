...
(
	...
	servie_charge			BIGINT 		 NOT NULL,
	total_amount			BIGINT		 NOT NULL
)ENGINE InnoDB;

ALTER TABLE orders 
CHANGE servie_charge service_charge BIGINT NOT NULL;
...
VALUES ('122', NOW(), 'galery_olahraga_indonesia', 'Galeri Olahraga Indoneia', 'rizkyabi', 'Rizky abi',
        'Rendika', 'Jalan Raya Xxx, Jakarta, DKI Jakarta, 434343', '089898989',
